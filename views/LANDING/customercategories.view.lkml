# The name of this view in Looker is "Customercategories"
view: customercategories {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "LANDING"."CUSTOMERCATEGORIES" ;;
  ...
  dimension: customercategoryname {
    type: string
  ...
  measure: count {
    type: count
    drill_fields: [customercategoryname]
  }
}
